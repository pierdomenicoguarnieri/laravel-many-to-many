<aside class="h-100 text-white">
  ...
  <ul class="p-0 w-100">
    ...
    <li class="w-100 py-2 {{Route::currentRouteName() === 'admin.types.index' || Route::currentRouteName() === 'admin.types.show' || Route::currentRouteName() === 'admin.types.edit' || str_contains(Route::currentRouteName(), 'admin.orderBy') ?  'active' : '' }}">
